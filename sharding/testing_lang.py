...
class Record(object):
    ...
    def add_collation_by_parent_coordinate(
        ...
        if len(layer_at_height) == 1:
            ...
            print("!@# shard_head set:", self.shard_head[shard_id]['hash'])
